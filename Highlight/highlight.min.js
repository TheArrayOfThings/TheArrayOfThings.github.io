...
var hljs = function () {
  ...
  var b = "[a-zA-Z]\\w*",
    ...
    var r = u("I", "a", "is", "so", "us", "to", "at", "if", "in", "it", "on", /[A-Za-z]+['](d|ve|re|ll|t|s|n)/, /[A-Za-z]+[-][a-z]+/, /[A-Za-z][a-z]{2,}/);
  ...
  function A(e, t) {
    t && e.beginKeywords && (e.begin = "\\b(" + e.beginKeywords.split(" ").join("|") + ")(?!\\.)(?=\\b|\\s)", e.__beforeBegin = R, e.keywords = e.keywords || e.beginKeywords, delete e.beginKeywords, void 0 === e.relevance && (e.relevance = 0));
  }

  function I(e, t) {
    Array.isArray(e.illegal) && (e.illegal = u.apply(void 0, _toConsumableArray(e.illegal)));
  }
  ...
  var L = function L(e, t) {
    ...
    Object.keys(e).forEach(function (t) {
      delete e[t];
    }), e.keywords = n.keywords, e.begin = d(n.beforeMatch, d("(?=", n.begin, ")")), e.starts = {
      relevance: 0,
  ...
  var H = {},
    ...
    (_console = console).log.apply(_console, ["WARN: " + e].concat(t));
      ...
      z = function z(e, t) {
    H["".concat(e, "/").concat(t)] || (console.log("Deprecated as of ".concat(e, ". ").concat(t)), H["".concat(e, "/").concat(t)] = !0);
  },
      K = Error();

  function W(e, t, _ref3) {
    var n = _ref3.key;
    var i = 0;
    var r = e[n],
        s = {},
    ...
    for (var _e2 = 1; _e2 <= t.length; _e2++) {
      o[_e2 + i] = r[_e2], s[_e2 + i] = !0, i += h(t[_e2 - 1]);
    }
  ...
  function X(e) {
    (function (e) {
      ...
      if (Array.isArray(e.begin)) {
        ...
        if ("object" != _typeof(e.beginScope) || null === e.beginScope) throw $("beginScope must be object"), K;
        W(e, e.begin, {
          key: "beginScope"
        }), e.begin = p(e.begin, {
          joinWith: ""
      ...
      if (Array.isArray(e.end)) {
        ...
        if ("object" != _typeof(e.endScope) || null === e.endScope) throw $("endScope must be object"), K;
        W(e, e.end, {
          key: "endScope"
        }), e.end = p(e.end, {
          joinWith: ""
  ...
  function G(e) {
    ...
    var n = /*#__PURE__*/function () {
      ...
      _createClass(n, [{
        ...
        value: function addRule(e, t) {
          t.position = this.position++, this.matchIndexes[this.matchAt] = t, this.regexes.push([t, e]), this.matchAt += h(e) + 1;
        }
      }, {
        key: "compile",
    ...
    return e.classNameAliases = s(e.classNameAliases || {}), function n(r, o) {
      ...
      [j, B, X, L].forEach(function (e) {
        return e(r, o);
      }), e.compilerExtensions.forEach(function (e) {
        return e(r, o);
      }), r.__beforeBegin = null, [A, I, T].forEach(function (e) {
        return e(r, o);
      }), r.isCompiled = !0;
      var l = null;
      return "object" == _typeof(r.keywords) && r.keywords.$pattern && (r.keywords = Object.assign({}, r.keywords), l = r.keywords.$pattern, delete r.keywords.$pattern), l = l || /\w+/, r.keywords && (r.keywords = P(r.keywords, e.case_insensitive)), a.keywordPatternRe = t(l, !0), o && (r.begin || (r.begin = /\B|\b/), a.beginRe = t(r.begin), r.end || r.endsWithParent || (r.end = /\B|\b/), r.end && (a.endRe = t(r.end)), a.terminatorEnd = g(r.end) || "", r.endsWithParent && o.terminatorEnd && (a.terminatorEnd += (r.end ? "|" : "") + o.terminatorEnd)), r.illegal && (a.illegalRe = t(r.illegal)), r.contains || (r.contains = []), r.contains = (_ref6 = []).concat.apply(_ref6, _toConsumableArray(r.contains.map(function (e) {
        return function (e) {
          ...
          })), e.cachedVariants ? e.cachedVariants : Z(e) ? s(e, {
  ...
  var J = function (e) {
    ...
    function u(e, t, n, i) {
      var r = "",
          s = "";
      "object" == _typeof(t) ? (r = e, n = t.ignoreIllegals, s = t.language, i = void 0) : (z("10.7.0", "highlight(lang, code, ...args) has been deprecated."), z("10.7.0", "Please use highlight(code, options) instead.\nhttps://github.com/highlightjs/highlight.js/issues/2277"), s = e, r = t), void 0 === n && (n = !0);
      var o = {
        code: r,
        language: s
      };
    ...
    function h(e, n, r, s) {
      ...
      function c() {
        ...
        var t = k.keywordPatternRe.exec(M),
            n = "";

        for (; t;) {
          n += M.substring(e, t.index);

          var _r = _.case_insensitive ? t[0].toLowerCase() : t[0],
              _s2 = (i = _r, k.keywords[i]);
          ...
          if (_s2) {
            ...
            if (S.addText(n), n = "", l[_r] = (l[_r] || 0) + 1, l[_r] <= 7 && (R += _i2), _e3.startsWith("_")) n += t[0];else {
              var _n3 = _.classNameAliases[_e3] || _e3;

              S.addKeyword(t[0], _n3);
            }
          } else n += t[0];
      ...
      function u(e, t) {
        ...
        for (; void 0 !== t[n];) {
          ...
          var _i3 = _.classNameAliases[e[n]] || e[n],
              _r2 = t[n];

          _i3 ? S.addKeyword(_r2, _i3) : (M = _r2, c(), M = ""), n++;
        }
      }

      function p(e, t) {
        return e.scope && "string" == typeof e.scope && S.openNode(_.classNameAliases[e.scope] || e.scope), e.beginScope && (e.beginScope._wrap ? (S.addKeyword(M, _.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), M = "") : e.beginScope._multi && (u(e.beginScope, t), M = "")), k = Object.create(e, {
          parent: {
            value: k
          }
        }), k;
      ...
      function x(e) {
        ...
        if (!r) return q;
        var s = k;
        k.endScope && k.endScope._wrap ? (d(), S.addKeyword(t, k.endScope._wrap)) : k.endScope && k.endScope._multi ? (d(), u(k.endScope, e)) : s.skip ? M += t : (s.returnEnd || s.excludeEnd || (M += t), d(), s.excludeEnd && (M = t));

        do {
          k.scope && !k.isMultiClass && S.closeNode(), k.skip || k.subLanguage || (R += k.relevance), k = k.parent;
        } while (k !== r.parent);
      ...
      function w(t, s) {
        ...
        if ("begin" === y.type && "end" === s.type && y.index === s.index && "" === a) {
          if (M += n.slice(s.index, s.index + 1), !o) {
            ...
            throw _t4.languageName = e, _t4.badRule = y.rule, _t4;
          }

          return 1;
        }

        if (y = s, "begin" === s.type) return function (e) {
          var t = e[0],
              n = e.rule,
              r = new i(n),
          ...
          for (var _i4 = 0, _s4 = s; _i4 < _s4.length; _i4++) {
            var _n5 = _s4[_i4];
            if (_n5 && (_n5(e, r), r.isMatchIgnored)) return m(t);
          }

          return n.skip ? M += t : (n.excludeBegin && (M += t), d(), n.returnBegin || n.excludeBegin || (M = t)), p(n, e), n.returnBegin ? 0 : t.length;
        }(s);

        if ("illegal" === s.type && !r) {
          var _e4 = Error('Illegal lexeme "' + a + '" for mode "' + (k.scope || "<unnamed>") + '"');

          throw _e4.mode = k, _e4;
        }
      ...
      (function () {
        ...
        for (var _t5 = k; _t5 !== _; _t5 = _t5.parent) {
    ...
    function f(e, n) {
      ...
      var i = function (e) {
        ...
        return t._emitter.addText(e), t;
          ...
          r = n.filter(E).filter(y).map(function (t) {
        return h(t, e, !1);
      });
    ...
    function p(e) {
      ...
      var n = function (e) {
        ...
        if (n) {
          ...
          return _t7 || (U(a.replace("{}", n[1])), U("Falling back to no-highlight mode for this block.", e)), _t7 ? n[1] : "no-highlight";
        }
      ...
      w("before:highlightElement", {
        el: e,
        language: n
      }), !g.ignoreUnescapedHTML && e.children.length > 0 && (console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."), console.warn("https://github.com/highlightjs/highlight.js/issues/2886"), console.warn(e)), t = e;
      var i = t.textContent,
          s = n ? u(i, {
        language: n,
        ignoreIllegals: !0
    ...
    "undefined" != typeof window && window.addEventListener && window.addEventListener("DOMContentLoaded", function () {
      ...
      highlightBlock: function highlightBlock(e) {
        return z("10.7.0", "highlightBlock will be removed entirely in v12.0"), z("10.7.0", "Please use highlightElement now."), p(e);
      },
  ...
  for (var _i6 = 0, _Object$keys2 = Object.keys(Y); _i6 < _Object$keys2.length; _i6++) {
    var _e8 = _Object$keys2[_i6];

    var _t9 = _e8.replace("grmr_", "");

    Q.registerLanguage(_t9, Y[_e8]);
  }
  ...
  return a("//", "$"), a("/\\*", "\\*/"), a("#", "$"), function (e) {
    var a = {
      ...
      variants: [{
        ...
        l = "[0-9](_?[0-9])*",
        c = "(\\b(".concat(l, "))?\\.(").concat(l, ")|\\b(").concat(l, ")\\."),
        b = {
      className: "number",
      relevance: 0,
      variants: [{
        begin: "(\\b(".concat(l, ")|(").concat(c, "))[eE][+-]?(").concat(l, ")[jJ]?\\b")
      }, {
        begin: "(".concat(c, ")[jJ]?")
      }, {
...
hljs.registerLanguage("sql", function () {
  ...
  function t() {
    ...
    return "(" + (function (e) {
      var r = e[e.length - 1];
      return "object" == _typeof(r) && r.constructor === Object ? (e.splice(e.length - 1, 1), r) : {};
    }(r).capture ? "" : "?:") + r.map(function (r) {
      return e(r);
    }).join("|") + ")";
  }
...
hljs.registerLanguage("rust", function () {
  ...
  return function (t) {
    ...
    var a;
    var r = "([ui](8|16|32|64|128|size)|f(32|64))?",
...
hljs.registerLanguage("perl", function () {
  ...
  function t() {
    for (var _len18 = arguments.length, n = new Array(_len18), _key18 = 0; _key18 < _len18; _key18++) {
      n[_key18] = arguments[_key18];
    }
  ...
  return function (e) {
    var r = /[dualxmsipngr]{0,12}/,
      ...
      contains: [e.HASH_COMMENT_MODE, {
        className: "regexp",
        variants: [{
          begin: l("s|tr|y", t.apply(void 0, g.concat([{
            capture: !0
          }])))
        }, {
          begin: l("s|tr|y", "\\(", "\\)")
        ...
        variants: [{
          ...
          begin: d("m|qr", t.apply(void 0, g.concat([{
            capture: !0
          }])), /\1/)
        }, {
          begin: d("m|qr", /\(/, /\)/)
  ...
  return function (b) {
    var d = {
      ...
      var d = e,
        ...
        className: "number",
        variants: [{
          begin: "(\\b(".concat(E, ")((").concat(m, ")|\\.)?|(").concat(m, "))[eE][+-]?([0-9](_?[0-9])*)\\b")
        }, {
          begin: "\\b(".concat(E, ")\\b((").concat(m, ")\\b|\\.)?|(").concat(m, ")\\b")
        }, {
      ...
      var h = [].concat(A, f.contains),
        ...
        illegal: /%/
          ...
          x = {
        match: l(/\b/, (T = [].concat(r, ["super"]), l("(?!", T.join("|"), ")")), d, o(/\(/)),
    ...
    return Object.assign(m.keywords, d), m.exports.PARAMS_CONTAINS.push(g), m.contains = m.contains.concat([g, {
      beginKeywords: "namespace",
      end: /\{/,
      excludeEnd: !0
    }, {
      ...
      relevance: 10,
      begin: /^\s*['"]use strict['"]/
    }), m.contains.find(function (e) {
      return "func.def" === e.label;
    }).relevance = 0, Object.assign(m, {
      name: "TypeScript",
      aliases: ["ts", "tsx"]
    }), m;
  };
...
hljs.registerLanguage("swift", function () {
  ...
  function t() {
    for (var _len20 = arguments.length, a = new Array(_len20), _key20 = 0; _key20 < _len20; _key20++) {
  ...
  return function (e) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        var _a2 = _e9.contains.find(function (e) {
          return "interpol" === e.label;
        });

        _a2.keywords = k;

        var _t10 = [].concat(B, _, M, [I, P], z);

        _a2.contains = [].concat(_toConsumableArray(_t10), [{
          begin: /\(/,
          end: /\)/,
          contains: ["self"].concat(_toConsumableArray(_t10))
        }]);
      }
    } catch (err) {
      _iterator.e(err);
...
hljs.registerLanguage("csharp", function () {
  ...
  return function (e) {
    ...
    r.contains = [o, c, s, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, a, e.C_BLOCK_COMMENT_MODE], l.contains = [d, c, t, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, a, e.inherit(e.C_BLOCK_COMMENT_MODE, {
      illegal: /\n/
    })];
  ...
  return function (n) {
    ...
    return {
      ...
      contains: [n.C_BLOCK_COMMENT_MODE, {
        ...
        contains: [a.HEXCOLOR, a.IMPORTANT, a.CSS_NUMBER_MODE].concat(l, [{
          begin: /(url|data-uri)\(/,
          end: /\)/,
          relevance: 0,
          keywords: {
  ...
  return function (b) {
    ...
    var h = [].concat(v, _.contains),
      ...
      illegal: /%/
        ...
        T = {
      match: l(/\b/, (x = [].concat(r, ["super"]), l("(?!", x.join("|"), ")")), g, o(/\(/)),
      className: "title.function",
      relevance: 0
    };
    var x;
...
hljs.registerLanguage("markdown", function () {
  ...
  function n() {
    for (var _len27 = arguments.length, n = new Array(_len27), _key27 = 0; _key27 < _len27; _key27++) {
      n[_key27] = arguments[_key27];
    }
...
hljs.registerLanguage("cpp", function () {
  ...
  return function (n) {
    var a = n.COMMENT("//", "$", {
      ...
      begin: t(/\b/, /(?!decltype)/, /(?!if)/, /(?!for)/, /(?!while)/, n.IDENT_RE, (m = /(<[^<>]+>|)\s*\(/, t("(?=", m, ")")))
    };
    var m;
    var g = [_, l, s, a, n.C_BLOCK_COMMENT_MODE, o, c],
        f = {
      variants: [{
        begin: /=/,
        end: /;/
...
hljs.registerLanguage("r", function () {
  ...
  return function (n) {
    var a = /(?:(?:[a-zA-Z]|\.[._a-zA-Z])[._a-zA-Z0-9]*)|\.(?!\d)/,
